...
def print_usage_examples():
    ...
    print("python tools/python/extract_calibration_data.py report.html --csv")
    print()
    print("# Extract data and create interactive plots")
    print("python tools/python/extract_calibration_data.py report.html --csv --plot")
    print()
    print("# Specify custom output directory")
    print("python tools/python/extract_calibration_data.py report.html --csv --output-dir ./analysis/")
    ...
    print("python tools/python/compare_calibration_data.py pre_bake_report.html post_bake_report.html")
    print()
    print("# Save comparison to specific file")
    print("python tools/python/compare_calibration_data.py pre_bake.html post_bake.html --output comparison.html")
    print()
    print("# Run comparison without showing plot in browser")
    print("python tools/python/compare_calibration_data.py pre_bake.html post_bake.html --no-show")
    ...
    print("4. python tools/python/compare_calibration_data.py pre_bake_report.html post_bake_report.html")
