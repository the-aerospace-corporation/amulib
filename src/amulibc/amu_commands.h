...
typedef enum {
	CMD_USB_SYSTEM_CONFIG_CURR_GAIN =		CMD_USB_SYSTEM + 0x00,
	CMD_USB_SYSTEM_CONFIG_CURR_RSENSE =		CMD_USB_SYSTEM + 0x01,
	CMD_USB_SYSTEM_CONFIG_VOLT_R1 =			CMD_USB_SYSTEM + 0x02,
	CMD_USB_SYSTEM_CONFIG_VOLT_R2 =			CMD_USB_SYSTEM + 0x03,
	
	CMD_USB_SYSTEM_CONFIG_SAVE = 			CMD_USB_SYSTEM + 0x07,
